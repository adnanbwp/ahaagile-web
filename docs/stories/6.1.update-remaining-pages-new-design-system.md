...
## Tasks / Subtasks
- [ ] Task 1: Update Case Study Page Design System Integration (AC: 1, 4, 6)
  - [ ] Replace hard-coded colors in case study page with design system colors
  - [ ] Update typography to use Inter font for headings and Source Serif 4 for body text
  - [ ] Replace blue-600/blue-700 CTA buttons with accent yellow design system colors
  - [ ] Apply consistent spacing using design system spacing variables
  - [ ] Update markdown component styling to match homepage and services page standards
  - [ ] Ensure professional consultancy brand positioning with sophisticated visual design
- [ ] Task 2: Enhance Book Consultation Page Professional Styling (AC: 2, 5, 6)
  - [ ] Review current book consultation page styling against design system standards
  - [ ] Update any inconsistent color usage to match brand navy and accent yellow palette
  - [ ] Ensure hero section, benefit cards, and CTA section maintain consistent styling
  - [ ] Verify Calendly widget integration continues to function correctly
  - [ ] Apply professional typography hierarchy throughout the page
  - [ ] Maintain existing functionality while enhancing visual presentation
- [ ] Task 3: Update Shared Markdown Content Rendering (AC: 4, 7, 8)
  - [ ] Create or update shared markdown component utilities for consistent rendering
  - [ ] Apply design system colors to all markdown-rendered links and buttons
  - [ ] Ensure consistent typography hierarchy across all markdown content
  - [ ] Update blockquote, code, and other markdown elements to use design system styling
  - [ ] Implement responsive typography that works across all device sizes
  - [ ] Ensure proper contrast ratios and accessibility compliance
- [ ] Task 4: Cross-Page Navigation and Layout Consistency (AC: 3, 7, 8)
  - [ ] Verify all pages use the enhanced Header component from Epic 2
  - [ ] Verify all pages use the enhanced Footer component from Epic 2
  - [ ] Ensure consistent page layout structure across homepage, services, case study, and book consultation
  - [ ] Test cross-page navigation flows for consistent user experience
  - [ ] Verify responsive behavior and visual consistency across all pages
  - [ ] Test dark mode compatibility across all pages
- [ ] Task 5: Create comprehensive unit tests for updated pages (Testing Requirements)
  - [ ] Update case study page tests to cover new design system integration
  - [ ] Update book consultation page tests to verify styling consistency
  - [ ] Test markdown rendering components for consistent styling
  - [ ] Test cross-page navigation and layout consistency
  - [ ] Test responsive behavior across different viewport sizes
  - [ ] Test accessibility compliance with proper semantic structure
