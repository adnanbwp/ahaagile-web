    ...
    >
      ...
      <div className="container-brand relative z-10">
        <div className="text-center max-w-5xl mx-auto mb-16 stagger-animation">
          ...
          {/* Subtitle */}
          <p className="text-subhero mb-12 text-gray-200 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            ...
            <Link 
              href="/case-study" 
              className="btn-secondary bg-white/10 text-white border-white/30 hover:bg-white hover:text-brand-navy px-8 py-4 text-lg font-semibold w-full sm:w-auto"
            >
              Watch Demo
            </Link>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-20 max-w-4xl mx-auto">
          <div className="text-center bg-white/10 backdrop-blur-md rounded-xl p-8 border border-white/20">
            ...
            <h3 className="text-3xl font-bold text-white mb-2">85% Time Reduction</h3>
            <p className="text-gray-200">Average workflow efficiency improvement across all client implementations</p>
          </div>
          ...
          <div className="text-center bg-white/10 backdrop-blur-md rounded-xl p-8 border border-white/20">
            ...
            <h3 className="text-3xl font-bold text-white mb-2">$330K+ Annual Savings</h3>
            <p className="text-gray-200">Typical revenue recovery potential for mid-sized professional services firms</p>
          </div>
        </div>
        ...
        <div className="text-center bg-white/5 backdrop-blur-md rounded-xl p-8 border border-white/10">
          ...
          <h3 className="text-2xl font-bold text-white mb-4">Trusted by 500+ Companies</h3>
          <p className="text-gray-200 mb-8">Leading professional services firms worldwide rely on our automation solutions</p>
          
          {/* Placeholder Company Logos */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center opacity-60">
            <div className="h-12 bg-white/20 rounded-lg flex items-center justify-center">
              <span className="text-white font-semibold text-sm">COMPANY A</span>
            </div>
            <div className="h-12 bg-white/20 rounded-lg flex items-center justify-center">
              <span className="text-white font-semibold text-sm">COMPANY B</span>
            </div>
            <div className="h-12 bg-white/20 rounded-lg flex items-center justify-center">
              <span className="text-white font-semibold text-sm">COMPANY C</span>
            </div>
            <div className="h-12 bg-white/20 rounded-lg flex items-center justify-center">
              <span className="text-white font-semibold text-sm">COMPANY D</span>
            </div>
          </div>
        </div>
      </div>
